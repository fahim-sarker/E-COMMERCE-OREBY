...
const Header = () => {
    ...
    useEffect(() => {
        document.addEventListener("click", (e) => {
            if (menulist.current.contains(e.target) == true) {
                setShow(!show)
            } else {
                setShow(false)
            }
                ...
                <Container>
                    <div className="flex py-[32px] justify-between bg-[#ffff]">
                        ...
                        <div className=" w-3/4 z-50">
                            <ul className={`lg:flex gap-x-[40px] lg:justify-center pt-[30px] lg:pt-[0] lg:static text-center font-sans] text-[20px] absolute  duration-700 ease-out ${show == true ? "bg-[#262626] w-[60%]  top-[50px] left-[0px] h-full" : "bg-[] top-[50px] h-full left-[-100px]"}`}>
                        ...
                        <div ref={menulist} className="lg:hidden">
